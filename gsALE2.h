...
{
public:
    gsALE2(gsMultiPatch<T> & geometry, const gsMultiPatch<T> & displacement,
          const gsBoundaryInterface & interfaceStr2Mesh, ale_method::method method);
    
     gsALE2(gsMultiPatch<T> & geometry, const gsMatrix<T> & displacement,
...
#include GISMO_HPP_HEADER(gsALE2.hpp)
#endif
