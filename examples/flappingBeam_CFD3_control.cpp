...
///
/// INSE are solved using the semi-implicit (a.k.a. IMEX) scheme
...
int main(int argc, char* argv[]){
    ...
    timeSolver.options().setInt("Scheme",time_integration::explicit_lumped);
    ...
    timeSolver.homogenizeFixedDofs(-1);
    clock.restart();
