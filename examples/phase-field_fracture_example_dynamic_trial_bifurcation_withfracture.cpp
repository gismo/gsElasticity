...
int main(int argc, char *argv[])
{
    ...
    {
        case 2:
            solve<2>(materialParameters,controlParameters,mp_ini,damage,bc_u,bc_d,plot,plotmod,outputdir);
            break;
        case 3:
            solve<3>(materialParameters,controlParameters,mp_ini,damage,bc_u,bc_d,plot,plotmod,outputdir);
            break;
        default:
