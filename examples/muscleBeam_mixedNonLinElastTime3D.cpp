...
int main(int argc, char* argv[]){
    ...
    real_t viscosityMuscle = 1.0e4;
    real_t viscosityTendon = 1.0e4;
    real_t density = 9.0e2;
    index_t numUniRef = 3;
...
//    (static_cast<gsTensorNurbsBasis<3,real_t> &>(basisDisplacement.piece(0))).knots();
    ...
    // source function, rhs
    gsConstantFunction<> g(0.,0.,0.01,3);
